<template>
    <div class="aws-cloudwatch-scoped">
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow">
            <div class="relative"><!---->
                <div class="overflow-hidden overflow-x-auto relative">
                    <table class="w-full table-default" data-testid="resource-table">
                        ...
                        <tbody>
                        <tr dusk="2-row" class="group cursor-pointer " v-for="stream in streams" @click="visit(group, stream.name)">
                            ...
                            <td class="px-2 py-2 border-t border-gray-100 dark:border-gray-700 whitespace-nowrap dark:bg-gray-800 group-hover:bg-gray-50 dark:group-hover:bg-gray-900">
                                    ...
                                    <span class="text-90 whitespace-nowrap"
                                          v-text="(stream.timestamps.firstEventTimestamp)"></span>

                            </td>

                            <td class="px-2 py-2 border-t border-gray-100 dark:border-gray-700 whitespace-nowrap dark:bg-gray-800 group-hover:bg-gray-50 dark:group-hover:bg-gray-900">
                                <span class="text-90 whitespace-nowrap"
                                      v-text="(stream.timestamps.lastEventTimestamp)"></span>
                            </td>

                            <td class="px-2 py-2 border-t border-gray-100 dark:border-gray-700 whitespace-nowrap dark:bg-gray-800 group-hover:bg-gray-50 dark:group-hover:bg-gray-900">
                                <span class="text-90 whitespace-nowrap"
                                      v-text="(stream.timestamps.lastIngestionTime)"></span>
                            </td>


                            <td class="py-2 border-t border-gray-100 dark:border-gray-700 px-2 td-fit text-right align-middle dark:bg-gray-800 group-hover:bg-gray-50 dark:group-hover:bg-gray-900">
                                <div class="flex items-center justify-end space-x-0 text-gray-400">
                                    <div aria-label="Bekijken"
...
defineProps<{
  group: string,
  streams: {name:string,timestamps:{firstEventTimestamp:string,lastEventTimestamp:string,lastIngestionTime:string}}[]
}>()

function visit(group: string, stream: string)
{
  return Nova.visit(`/nova-aws-cloudwatch/groups/`+group+'/streams/'+stream)
}
</script>
